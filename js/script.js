const runScripts = function () {
	...
	tl.addLabel("start")
	  .to("div.logo", { scale: 0.25, transformOrigin: 'top left' }, 0)
	  .to("nav.nav", { boxShadow: '0px 0px 19px 0px rgba(125,125,125,0.15', height: '6.4rem' }, 0)
	  .to("div.nav__links", { paddingTop: '2rem' }, 0)
	  .to("div.nav__hamburger", { paddingTop: '2rem' }, 0)
}
